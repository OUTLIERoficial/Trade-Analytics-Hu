            ...
            {mode !== "registered" && (
              <>
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 bg-white dark:bg-white/10 border border-border rounded-xl text-sm font-semibold text-foreground hover:bg-muted/60 transition-all mb-4"
                >
                  {GOOGLE_ICON}
                  Entrar com Google
                </a>
